...
public class TestCases
{
   ...
   {
      assertEquals(-5, new Point(-5, 2.0).getX(), DELTA);
   }

   @Test
   public void testGetY()
   {
      assertEquals(-1.4, new Point(2.0,-1.4).getY(), DELTA);
   }

   @Test
   public void testGetY2()
   {
      assertEquals(6.9, new Point(2.0,6.9).getY(), DELTA);
   }
   ...
   {
      assertEquals(1.10714, new Point(2.0, 4.0).getAngle(),DELTA);
   }
   ...
   {  
      ...
      assertEquals(2.0, new Point(2.0, 4.0).rotate90().getY(),DELTA);
   }
